...
<xsl:variable name="doi024" select="//marc:datafield[@tag='024']/marc:subfield[@code='a']"/>
<xsl:variable name="doi035" select="//marc:datafield[@tag='035']/marc:subfield[@code='a']"/>

<xsl:variable name="doi">
	<xsl:choose>
		<xsl:when test="string-length($doi024)=0 and string-length($doi035)>0">
			<xsl:value-of select="$doi035"/>
		</xsl:when>
		<xsl:otherwise>
			<xsl:value-of select="$doi024"/>
		</xsl:otherwise>
	</xsl:choose>
</xsl:variable>
	...
	<xsl:template match="/">
		...
		<div id="metadata">
<!--			<xsl:call-template name="linknewwindow"/> -->
	...
	<xsl:template name="linknewwindow">
		<xsl:element name="a">
			<xsl:attribute name="href">
				<xsl:text>http://digital.lib.usf.edu/special/getMetadata.php?doi=</xsl:text>
				<xsl:value-of select="$doi"/>
			</xsl:attribute>
			<xsl:attribute name="target">_blank</xsl:attribute>
		<xsl:text>Open print friendly view in new tab/window</xsl:text>
		</xsl:element>
		<br/><br/>
	</xsl:template>
	...
	<xsl:template name="thumbnail">
		<xsl:element name="img">
			...
			<xsl:attribute name="alt">
				<xsl:text>Loading thumbnail for resource [</xsl:text>
				<xsl:value-of select="$doi"/>
				<xsl:text>]</xsl:text>
			</xsl:attribute>
			<xsl:attribute name="width">200</xsl:attribute>
			<xsl:attribute name="src">
				<xsl:text>http://digital.lib.usf.edu:8080/fedora/get/usfldc:</xsl:text>
				<xsl:value-of select="$doi"/>
...
-->
	...
	<xsl:template match="marc:datafield[@tag=024]">
		<br/><p><b>Digital ID:</b><xsl:text> </xsl:text>
...
<!--
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='e']">
				<li>Coordinateseasternmost longitude:
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			<xsl:for-each select="marc:subfield[@code='f']">
				<li>Coordinatesnorthernmost latitude:
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
...
<!--
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='b']">
				<li>Level of effort used to assign nonsubject heading access 
points:
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
...
<!--
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='b']">
				<li>Language code of summary or abstract/overprinted title 
or subtitle:
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			...
			<xsl:for-each select="marc:subfield[@code='g']">
				<li>Language code of accompanying material other than 
librettos:
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			<xsl:for-each select="marc:subfield[@code='h']">
				<li>Language code of original and/or intermediate 
...
-->
	<xsl:template match="marc:datafield[@tag=100 or @tag=110 or @tag=111 or @tag=720]">
		<p><b>Creator:</b><xsl:text> </xsl:text>
			<xsl:for-each select="marc:subfield">
				<xsl:value-of select="text()"/>
				<xsl:text> </xsl:text>
			</xsl:for-each>
...
<!--
	<xsl:template match="marc:datafield[@tag=111]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='q']">
				<li>Name of meeting following jurisdiction name entry 
element:
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
...
<!--
	...
	<xsl:template match="marc:datafield[@tag=242]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='c']">
				<li>Remainder of title page transcription /statement of 
responsibility:
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
...
<!--
			...
			<xsl:for-each select="marc:subfield[@code='f']">
				<li>Designation of volume and issue number and/or date of a 
work:
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
...
-->
	<xsl:template match="marc:datafield[@tag=260]">
		<p><b>Published:</b><xsl:text> </xsl:text>
			<xsl:for-each select="marc:subfield[@code='a']">
				<xsl:value-of select="text()"/>
				<xsl:text> </xsl:text>
			</xsl:for-each>
...
-->
	<xsl:template match="marc:datafield[@tag=300]">
		<p><b>Physical description:</b><xsl:text> </xsl:text>
			<xsl:for-each select="marc:subfield[@code='a']">
				<xsl:value-of select="text()"/>
				<xsl:text> </xsl:text>
			</xsl:for-each>
...
-->
	...
	<xsl:template match="marc:datafield[@tag=340]">
		<p><b>Medium:</b><xsl:text> </xsl:text>
			<xsl:for-each select="marc:subfield">
...
<!--
	<xsl:template match="marc:datafield[@tag=342]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='n']">
				<li>Azimuth measure point longitude or straight vertical 
longitude from pole:
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			...
			<xsl:for-each select="marc:subfield[@code='v']">
				<li>Local planar, local, or other projection or grid 
description:
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
...
-->
	<xsl:template match="marc:datafield[@tag=518]">
		<p><b>Date/Time of Event:</b><ul><li>
			<!-- a -->
			<xsl:for-each select="marc:subfield">
				<xsl:value-of select="text()"/>
				<xsl:text> </xsl:text>
...
-->
	...
	<xsl:template match="marc:datafield[@tag=520]">
		<p><b>Summary:</b><xsl:text> </xsl:text>
			<!-- 6 -->
			<xsl:for-each select="marc:subfield">
				<xsl:value-of select="text()"/>
				<xsl:text> </xsl:text>
...
<!--
	...
	<xsl:template match="marc:datafield[@tag=533]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='m']">
				<li>Dates of publication and/or sequential designation of 
issues reproduced:
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
...
-->
	<xsl:template match="marc:datafield[@tag=540]">
		<p><b>Reproduction note:</b><xsl:text> </xsl:text>
			<xsl:for-each select="marc:subfield">
				<xsl:value-of select="text()"/><xsl:text> </xsl:text>
			</xsl:for-each>
		</p>
...
-->
	...
	<xsl:template match="marc:datafield[@tag=546]">
                ...
                <p><b>Language:</b><xsl:text> </xsl:text>
                        <xsl:for-each select="marc:subfield">
                                <xsl:value-of select="text()"/>
                                <xsl:text> </xsl:text>
                        </xsl:for-each>
...
-->
	...
	<xsl:template  match="marc:datafield[@tag=600 or @tag=610 or @tag=611 or @tag=650 or @tag=651 or @tag=653 or @tag=655 or @tag=656 or tag=657 or tag=658]">
	</xsl:template>

	<xsl:template name="subjects">

		<xsl:if test="//marc:datafield[@tag=600 or @tag=610 or @tag=611 or @tag=650 or @tag=651 or @tag=653 or @tag='655' or @tag='656' or @tag='657'or tag='658']">
			<p><b>Subjects:</b>

			<blockquote>	
			<xsl:for-each select="//marc:datafield[@tag=600 or @tag=610 or @tag=611 or @tag=650 or @tag=651 or @tag=653 or @tag='655' or @tag='656' or @tag='657'or tag='658']">
				<!-- 3 -->
<!--				<xsl:text disable-output-escaping="yes">&lt;a href=&#034;#?search=</xsl:text> -->
				<xsl:for-each select="marc:subfield">
					<xsl:value-of select="text()"/>
					<xsl:text> </xsl:text>
				</xsl:for-each>
...
<!--	<xsl:template match="marc:datafield[@tag=655]">
		<p><b>Genre/form:</b><xsl:text> </xsl:text>
			<xsl:for-each select="marc:subfield">
				<xsl:value-of select="text()"/>
				<xsl:text> </xsl:text>
			</xsl:for-each>
...
-->
	...
	<xsl:template match="marc:datafield[@tag=700 or @tag=710 or @tag=711]">
		<p><b>Other Contributers:</b><xsl:text> </xsl:text>
			<!-- 3 -->
			<xsl:for-each select="marc:subfield">
				<xsl:value-of select="text()"/>
				<xsl:text> </xsl:text>
...
-->
	...
	<xsl:template match="marc:datafield[@tag=752]">
		<xsl:variable name="HPNA" select="marc:subfield[@code='a']"/>
		<xsl:variable name="HPNB" select="marc:subfield[@code='b']"/>
		<xsl:variable name="HPNC" select="marc:subfield[@code='c']"/>
		<xsl:variable name="HPND" select="marc:subfield[@code='d']"/>

		<p><b>Hierarchical place name:</b><xsl:text> </xsl:text>
			<xsl:if test="string-length($HPNA) &gt; 0">
				<xsl:value-of select="$HPNA"/>
			</xsl:if>

			<xsl:if test="string-length($HPNA) &gt; 0 and (string-length($HPNB) &gt; 0 or string-length($HPNC) &gt; 0 or string-length($HPND) &gt; 0)">
				<xsl:text>--</xsl:text>
			</xsl:if>

			<xsl:if test="string-length($HPNB) &gt; 0">     
                                <xsl:value-of select="$HPNB"/>
                        </xsl:if>

                        <xsl:if test="string-length($HPNB) &gt; 0 and (string-length($HPNC) &gt; 0 or string-length($HPND) &gt; 0)">
                                <xsl:text>--</xsl:text>
                        </xsl:if>

			<xsl:if test="string-length($HPNC) &gt; 0">
				<xsl:value-of select="$HPNC"/>
			</xsl:if>

			<xsl:if test="string-length($HPNC) &gt; 0 and string-length($HPND) &gt; 0">
				<xsl:text>--</xsl:text>
			</xsl:if>

			<xsl:if test="string-length($HPND) &gt; 0">     
                                <xsl:value-of select="$HPND"/>
                        </xsl:if>
...
-->
	<xsl:template match="marc:datafield[@tag=773]">
			<xsl:for-each select="marc:subfield">
				<p><b>Collection:</b><xsl:text> </xsl:text>
				<xsl:value-of select="text()"/><xsl:text> </xsl:text>
				</p>
			</xsl:for-each>
<!--
...
-->
	...
	<xsl:template match="marc:datafield[@tag=786]">
	                <p><b>Source:</b><xsl:text> </xsl:text>
                        <xsl:for-each select="marc:subfield">
                                <xsl:value-of select="text()"/>
                                <xsl:text> </xsl:text>
                        </xsl:for-each>
...
issues reproduced:
	...
	<xsl:template match="marc:datafield[@tag=853]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='g']">
				<li>Alternative numbering scheme, first level of 
enumeration:
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			<xsl:for-each select="marc:subfield[@code='h']">
				<li>Alternative numbering scheme, second level of 
enumeration:
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
...
enumeration:
	...
	<xsl:template match="marc:datafield[@tag='856']/marc:subfield[@code='q']"></xsl:template>
	<xsl:template match="marc:datafield[@tag='856']/marc:subfield[@code='y']"></xsl:template>
	<xsl:template match="marc:datafield[@tag='856']/marc:subfield[@code='u']"></xsl:template>

	<xsl:template match="marc:datafield[@tag='856' and @ind1='4' and @ind2='2']/marc:subfield[@code='u']">
...
enumeration:
	...
	<xsl:template match="marc:datafield[@tag=870]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='j']">
				<li>Tag and sequence number of the field for which 870 is a 
variant(R):
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
	...
	<xsl:template match="marc:datafield[@tag=871]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='j']">
				<li>Tag and sequence number of the field for which 871 is a 
variant(R):
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
	...
	<xsl:template match="marc:datafield[@tag=872]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='j']">
				<li>Tag and sequence number of the field for which 872 is a 
variant(R):
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
...
element:
	...
	<xsl:template match="marc:datafield[@tag=873]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='j']">
				<li>Tag and sequence number of the field for which 873 is a 
variant(R):
				<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
...
<metaInformation>
<scenarios ><scenario default="no" name="Ray Charles" userelativepaths="yes" 
externalpreview="no" url="..\xml\MARC21slim\raycharles.xml" htmlbaseurl="" 
...
postprocessgeneratedext=""/><scenario default="yes" name="s7" 
userelativepaths="yes" externalpreview="no" url="..\ifla\sally7.xml" 
htmlbaseurl="" processortype="internal" commandline="" additionalpath="" 
additionalclasspath="" postprocessortype="none" postprocesscommandline="" 
postprocessadditionalpath="" postprocessgeneratedext=""/></scenarios><MapperInfo 
srcSchemaPath="" srcSchemaRoot="" srcSchemaPathIsRelative="yes" 
